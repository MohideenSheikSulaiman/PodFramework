...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Mohideen Sheik Sulaiman A"
  # spec.authors            = { "Mohideen Sheik Sulaiman A" => "mohideen.sulaiman@zohocorp.com" }
  # spec.social_media_url   = "https://twitter.com/Mohideen Sheik Sulaiman A"
